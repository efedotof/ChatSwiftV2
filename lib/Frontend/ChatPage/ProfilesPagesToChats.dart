                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Milendra',style: TextStyle(color: Color(0xFF171763), fontWeight: FontWeight.bold, fontSize: 24), ),
                              Text('Last seen on yesterday at 09:00 am',style: TextStyle(color: Color(0xFFDCDBEF),)),
                              SizedBox(height: MediaQuery.of(context).size.height * 0.04,),
      
      
                              Text('+ 1-889-348-8822',style: TextStyle(color: Color(0xFF171763), fontWeight: FontWeight.w500, fontSize: 18),),
                              Text('Phone number',style: TextStyle(color: Color(0xFFDCDBEF),)),
