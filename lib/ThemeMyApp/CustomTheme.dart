...
class CustomTheme with ChangeNotifier{
  ...
  static ThemeData get lightTheme { //1
    ...
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          ...
          selectedItemColor: Color(0xFF785AF0), // Цвет активных иконок и текста
          unselectedItemColor: Color(0xFFB4B0D3), // Цвет неактивных иконок
          selectedLabelStyle:  TextStyle(color:Color(0xFF785AF0)), // Цвет активного текста
          unselectedLabelStyle:  TextStyle(color:Color(0xFFB4B0D3)), // Цвет неактивного текста
        ),
